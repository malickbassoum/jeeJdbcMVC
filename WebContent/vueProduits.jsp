...
<link rel="stylesheet" type="text/css" href="css/style.css">
	<script type="text/javascript">
		...
		var rep=confirm("Etes vous de vouloir supprimer?");
		if(rep==true){
		...
		<div>
			<table class="table1">
				...
				<tr>
					...
					<td>${p.prix}</td>
					<td>${p.quantite}</td>
					<td><a href="javascript:confirmer('controller.php?action=delete&ref=${p.reference}')" >Supprimer</a></td>
					<td><a href="controller.php?action=edit&ref=${p.reference}" >Editer</a></td>
				</tr>
